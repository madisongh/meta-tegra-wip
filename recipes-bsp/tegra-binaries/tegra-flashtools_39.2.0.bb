...
SRC_URI = "\
    ...
    file://0001-Convert-BUP_generator.py-to-Python3.patch \
    file://0002-Convert-gen_tos_part_img.py-to-Python3.patch \
    file://0003-Update-tegra-python-scripts-for-Python3.patch \
...
do_install() {
    ...
    install -m 0755 ${S}/bootloader/xmss-sign ${D}${BINDIR}
